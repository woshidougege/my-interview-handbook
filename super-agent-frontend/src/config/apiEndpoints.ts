...
export const API_ENDPOINTS = {
  ...
  // ========== 工作空间相关 ==========
  // 后端: @RequestMapping("/api/v1/workspaces") -> 前端直接用: workspaces/*
  WORKSPACE: {
    BASE: 'workspaces',
    LIST: 'workspaces',
    CREATE: 'workspaces', 
  ...
  // ========== 对话任务相关 ==========
  // 后端: @RequestMapping("/api/v1/workspaces/{workspaceId}/chat-tasks") -> 前端直接用: workspaces/{workspaceId}/chat-tasks/*
  CHAT_TASK: {
